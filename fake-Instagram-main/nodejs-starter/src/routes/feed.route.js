...
// commentId is a feed id in particular comment
  router
  ...
  .patch(validate(FeedValidation.likecomment),feedController.Likecomment)


  router
  .route('/likecomment-reply/:feedId/:commentid/:replyid')
  .patch(feedController.Likecommentreply)

  router
  .route('/comment-reply/:feedid/:commentid')
  .patch( validate(FeedValidation.Feedcommentreply),feedController.Feedcommentreply)

  router
  .route('/savefeed/:FeedID')
  .get( validate(FeedValidation.Saveimage),feedController.Saveimage);

  router
  .route('/saveprofile')
  .get( validate(FeedValidation.Saveprofile),feedController.Saveprofile);
